...
<head>
  ...
  <!-- title -->
  <title>Toko Kebaya dan Jas</title>
...
<body id="home">
  ...
  <nav class="navbar-container">
    <div class="navbar-logo">
      <h3><a href="index.php">Toko Kebaya dan Jas</a></h3>
    </div>
    ...
    <div class="header-content">
      <div class="row">
        <div class="col-md-5 my-auto mx-auto" data-aos="fade-right">
          <h2>Toko Kebaya dan Jas</h2>
          <p>
            Toko Kebaya dan Jas adalah platform sewa kebaya dan jas secara online terbesar di Indonesia.
            Dengan memiliki fasilitas & pengiriman tercepat.
          </p>
          <a href="./shop" class="button button-purple">Sewa Sekarang</a>
        </div>
        <div class="col-md-6 my-auto mx-auto" data-aos="zoom-in">
          <div class="d-flex justify-content-center align-items-center flex-column">
            <img src="assets/img/kebayadanjas.png" alt="banner" class="my-5">
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="footer bg-dark" id="contact">
    <div class="footer-content">
      ...
      <div class="row">
        ...
        <div class="col-md-5 my-3 mx-auto" data-aos="fade-in">
          <h4 class="text-light text-poppins font-weight-bold">Toko Kebaya dan Jas</h4>
          <p class="d-block font-weight-light text-light">
            Toko Kebaya dan Jas adalah platform sewa kebaya dan jas secara online dengan fasilitas memadai.
          </p>
        </div>
      </div>
      <div class="row">
