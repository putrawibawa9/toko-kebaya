...
<body id="home">
  ...
  <nav class="navbar-container">
    <div class="navbar-logo">
      <h3><a href="./">Toko Kebaya dan Jas</a></h3>
    </div>
          ...
          <div class="col-md-4" data-aos="zoom-in">
            <div class="card-custom">
              ...
              <div class="card-custom-body d-flex justify-content-between">
                ...
                <?php if (isset($_SESSION['login'])) { ?>
                  <p onclick="addToCart(<?= $product['product_id'] ?>, 1, <?= $user_id ?>)" style="cursor: pointer;" class="button button-purple my-4"><i class="fas fa-shopping-cart"></i> Sewa</p>
                <?php } else { ?>
                  <a href="./auth/login" class="button button-purple my-4"><i class="fas fa-lock"></i> Sewa</a>
                <?php } ?>
              </div>
            </div>
          </div>
